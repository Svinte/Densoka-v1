...
b2 . luokanNimi = "sb" ;
const  b3  =  asiakirja . createElement ( "h1" ) ;
b3 . innerText = " Tietoa kirjasta " ;
b3 . innerText = " Minecraft - palvelin " ;
b3 . luokanNimi = "sb" ;
const  b4  =  asiakirja . createElement ( "h1" ) ;
b4 . innerText = " Minecraft - palvelin " ;
b4 . innerText = " Youtube kanava " ;
b4 . luokanNimi = "sb" ;
const  b5  =  asiakirja . createElement ( "h1" ) ;
b5 . innerText = " Youtube kanava " ;
b5 . innerText = " Discord - palvelin " ;
b5 . luokanNimi = "sb" ;
const  b6  =  asiakirja . createElement ( "h1" ) ;
b6 . innerText = " Discord - palvelin " ;
b6 . innerText = " Klaaniin liittyminen " ;
b6 . luokanNimi = "sb" ;
const  b7  =  asiakirja . createElement ( "h1" ) ;
b7 . innerText = " Klaaniin liittyminen " ;
b7 . innerText = " Muuta densokasta " ;
b7 . luokanNimi = "sb" ;
const  b8  =  asiakirja . createElement ( "h1" ) ;
b8 . innerText = "Muuta densokasta" ;
b8 . luokanNimi = "sb" ;
asiakirja . pää . appendChild ( tyyli ) ;
if  ( ikkuna . sisäleveys < 800 )  {
    const  bannertext  =  asiakirja . createElement ( "h1" ) ;
